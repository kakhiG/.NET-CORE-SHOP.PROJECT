...
namespace Shop.Application.Cart
{
    public class GetOrder
    {
        ...
        public class Response
        {
            ...
            public int GetTotalCharger() => Products.Sum(x => x.Value * x.Qty);
        ...
        public Response Do()
        {
            ...
            var customerInformation = JsonConvert.DeserializeObject<Shop.Domain.Models.CustomerInformation>(customerInforString);
